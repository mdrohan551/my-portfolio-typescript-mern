...
const TestimonialMockup: React.FC<props> = ({ data }) => {
    ...
    return (
        ...
        <div className='w-full mt-5 grid grid-cols-12 gap-5 bg-transparent shadow-lg px-3 py-3 rounded-2xl ring-1 ring-Light_primary hover:shadow-xl transition-all duration-300  relative'>
