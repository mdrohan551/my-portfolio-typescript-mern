...
const Button_link: React.FC<button_content> = ({ text, href }) => {
    return (
        <>
            <Link to={href} className="flex justify-between gap-2 items-center  bg-primary  hover:bg-gray-50 hover:ring-1 hover:ring-gray-800 px-5 md:px-2 py-2 font-jakarta-Semibold text-white rounded-xl group transition-all duration-300"
            >
